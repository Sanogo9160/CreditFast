...
#[OA\Tag(name: 'Scoring et analyse', description: 'Score d’aide à la décision. Calcul et lecture : Comité, Admin uniquement (pas agent ni analyste).')]
...
#[OA\Tag(name: 'Routage', description: 'Catalogue agences/zones, file à affecter, couverture agents. Rôle : Admin (catalogue : authentifié).')]
