...
class AdminController extends Controller
{
    ...
    #[OA\Post(
        ...
        description: '**Rôles :** Admin (`admin`). Rôles autorisés : admin, credit_agent, analyst, committee_member.',
        security: [['sanctum' => []]],
    ...
    #[OA\Post(
        ...
        description: '**Rôles :** Admin (`admin`). Le modèle reste en préparation jusqu’à activation.',
        security: [['sanctum' => []]],
